...
def infer():
    ...
    Layout_before_trt = LayoutInfer("./test_before.plan",
                        [[6, 512], [6, 512, 4], [6, 3, 224, 224], [6,709,768], [6,12,709,709],[6, 12,709,709]])
    Layout_fusion_trt = LayoutInfer("./test_fusion.plan",
                        [[6, 512], [6, 512, 4], [6, 3, 224, 224], [6,709,768], [6,12,709,709],[6, 12,709,709]])

    out_dyn = Layout_before_trt.layout_infer(input_ids, bbox, images)
    out_sta = Layout_fusion_trt.layout_infer(input_ids, bbox, images)
